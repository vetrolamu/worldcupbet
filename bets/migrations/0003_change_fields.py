...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'bets.bet': {
            ...
            'game': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['bets.Game']", 'unique': 'True'}),
        ...
        u'bets.game': {
            ...
            'home': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'home'", 'unique': 'True', 'null': 'True', 'to': u"orm['bets.Team']"}),
            'home_et_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'home_ft_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'home_pen_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {}),
            'visitor': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'visitor'", 'unique': 'True', 'null': 'True', 'to': u"orm['bets.Team']"}),
            'visitor_et_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'visitor_ft_score': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'visitor_pen_score': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
