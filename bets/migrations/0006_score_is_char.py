...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'bets_game', 'visitor_ft_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Game.home_et_score'
        db.alter_column(u'bets_game', 'home_et_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Game.visitor_pen_score'
        db.alter_column(u'bets_game', 'visitor_pen_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Game.home_ft_score'
        db.alter_column(u'bets_game', 'home_ft_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Game.visitor_et_score'
        db.alter_column(u'bets_game', 'visitor_et_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Game.home_pen_score'
        db.alter_column(u'bets_game', 'home_pen_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.visitor_ft_score'
        db.alter_column(u'bets_bet', 'visitor_ft_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.home_et_score'
        db.alter_column(u'bets_bet', 'home_et_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.visitor_pen_score'
        db.alter_column(u'bets_bet', 'visitor_pen_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.home_ft_score'
        db.alter_column(u'bets_bet', 'home_ft_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.home_pen_score'
        db.alter_column(u'bets_bet', 'home_pen_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))

        # Changing field 'Bet.visitor_et_score'
        db.alter_column(u'bets_bet', 'visitor_et_score', self.gf('django.db.models.fields.CharField')(max_length=3, null=True))
    ...
    models = {
        ...
        u'bets.bet': {
            ...
            'home_et_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'home_ft_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'home_pen_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'visitor_et_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'visitor_ft_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'}),
            'visitor_pen_score': ('django.db.models.fields.CharField', [], {'max_length': '3', 'null': 'True', 'blank': 'True'})
        },
        u'bets.game': {
